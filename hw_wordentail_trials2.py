...
print(pd.DataFrame(x_train)[1].value_counts())
...
print(len(positive_entailments))
...
for premise_hypothesis in positive_entailments:
    ...
    print("{0}:{1}:{2}:{3}".format(premise, hypothesis, wn_edges[premise], wn_edges[hypothesis]))
...
print(len(positive_entailments_ex))
